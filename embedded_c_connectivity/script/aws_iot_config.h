...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a3gydrlwsa86zj.iot.ap-southeast-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "AOTUSER-e5b1b8522939" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "e5b1b8522939" ///< Thing Name of the Shadow this device is associated with
